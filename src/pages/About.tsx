  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      description: 'Graduated with strong foundation in software engineering, algorithms, and system design.',
      icon: <School />,
      color: '#5AC8FA',
      achievements: [
    ...
    },
    {
      ...
      description: 'Built fintech and healthcare solutions, focusing on backend APIs and system optimization.',
      icon: <Code />,
      color: '#007AFF',
      achievements: [
    ...
    },
    {
      ...
      description: 'Leading development of secure trading systems and financial applications serving millions of users.',
      icon: <BusinessCenter />,
      color: '#00C896',
      achievements: [
      ...
      skills: ['Spring Boot', 'React', 'TypeScript', 'Security', 'Trading Systems']
    }
  ];
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 8, md: 12 } }}>
            ...
            >
              ...
              scalable applications and secure financial systems that impact millions of users.
            </Typography>
          </Box>
        </Container>
      </Box>
        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 600, mx: 'auto' }}>
              From computer science graduate to leading software engineer at JP Morgan Chase & Co.
            </Typography>
          </Box>
              ...
              >
                ...
                <Card
                  ...
                  sx={{
                    ...
                    transform: activeEvent === event.id ? 'scale(1.02)' : 'scale(1)',
                    transition: 'all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
                  }}
                >
                  <CardContent sx={{ p: { xs: 3, md: 4 } }}>
                    ...
                    {/* Achievements */}
                    <Box sx={{ mb: 3 }}>
                      <Typography variant="h6" sx={{ mb: 1.5, fontSize: '1rem', color: 'text.primary' }}>
                        Key Achievements
                      </Typography>
                            ...
                            <Chip
                              ...
                              sx={{
                                backgroundColor: theme.palette.mode === 'dark' 
                                  ...
                                  : 'rgba(0, 122, 255, 0.1)',
                                color: theme.palette.mode === 'dark' ? '#5AC8FA' : '#007AFF',
                                fontWeight: 500,
                              }}
                            />
                          ))}
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 600, mx: 'auto' }}>
              ...
              in building production-grade applications.
            </Typography>
          </Box>
          ...
          >
            {skillCategories.map((category, categoryIndex) => (
              <Card
                key={categoryIndex}
                sx={{
                  gridColumn: { xs: '1', lg: categoryIndex === 0 ? '1 / 3' : 'auto' },
                  height: 'fit-content',
                }}
              >
                <CardContent sx={{ p: { xs: 3, md: 4 } }}>
